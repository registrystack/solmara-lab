...
const DEFAULT_LOCAL_MAP: Record<string, string> = {
  ...
  'deterministic-publisher:8080': 'http://localhost:4331',
  'cra-evidence.solmara.registrystack.org': 'https://cra-evidence.solmara.registrystack.org',
  'nia-evidence.solmara.registrystack.org': 'https://nia-evidence.solmara.registrystack.org',
  'sro-evidence.solmara.registrystack.org': 'https://sro-evidence.solmara.registrystack.org',
  'mosd-programme-evidence.solmara.registrystack.org': 'https://mosd-programme-evidence.solmara.registrystack.org',
  'sipf-evidence.solmara.registrystack.org': 'https://sipf-evidence.solmara.registrystack.org',
  'nagdi-evidence.solmara.registrystack.org': 'https://nagdi-evidence.solmara.registrystack.org',
  'mint:8081': 'https://localhost:4341',
  'cra-relay:8080': 'http://localhost:4311',
  'nia-relay:8080': 'http://localhost:4312',
  'mosd-relay:8080': 'http://localhost:4314',
  'sipf-relay:8080': 'http://localhost:4315',
  'nagdi-relay:8080': 'http://localhost:4316',

...
DATASET_OFFERING_DEFAULTS = {
    "cra-civil": {
        ...
        "endpoint": "https://cra-notary.solmara.registrystack.org/evidence/v1",
    ...
    "nia-population": {
        ...
        "entity": "person",
        "service": "child-benefit-review",
        "endpoint": "https://nia-notary.solmara.registrystack.org/evidence/v1",
        "purposes": [CHILD_BENEFIT_PURPOSE],
    ...
    "sro-social": {
        ...
        "entity": "household",
        "service": "child-benefit-review",
        "endpoint": "https://sro-notary.solmara.registrystack.org/evidence/v1",
        "purposes": [CHILD_BENEFIT_PURPOSE],
    ...
    "mosd-programme": {
        ...
        "entity": "enrollment",
        "service": "child-benefit-review",
        "endpoint": "https://programme-notary.solmara.registrystack.org/evidence/v1",
        "purposes": [CHILD_BENEFIT_PURPOSE],
    ...
    "sipf-pensions": {
        ...
        "endpoint": "https://sipf-notary.solmara.registrystack.org/evidence/v1",

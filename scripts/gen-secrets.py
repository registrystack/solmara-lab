...
def main(argv: list[str] | None = None) -> int:
    ...
    values: dict[str, str] = {
        ...
        "CIVIL_CHILD_BENEFIT_NOTARY_POSTGRES_MIGRATOR_PASSWORD": raw_key(),
        "CIVIL_CHILD_BENEFIT_NOTARY_POSTGRES_RUNTIME_PASSWORD": raw_key(),
        "NIA_CHILD_BENEFIT_NOTARY_POSTGRES_MIGRATOR_PASSWORD": raw_key(),
        "NIA_CHILD_BENEFIT_NOTARY_POSTGRES_RUNTIME_PASSWORD": raw_key(),
        "SRO_CHILD_BENEFIT_NOTARY_POSTGRES_MIGRATOR_PASSWORD": raw_key(),
        "SRO_CHILD_BENEFIT_NOTARY_POSTGRES_RUNTIME_PASSWORD": raw_key(),
        "PROGRAMME_CHILD_BENEFIT_NOTARY_POSTGRES_MIGRATOR_PASSWORD": raw_key(),
        "PROGRAMME_CHILD_BENEFIT_NOTARY_POSTGRES_RUNTIME_PASSWORD": raw_key(),
        "PENSION_NOTARY_POSTGRES_MIGRATOR_PASSWORD": raw_key(),
        "PENSION_NOTARY_POSTGRES_RUNTIME_PASSWORD": raw_key(),
        "NAGDI_NOTARY_POSTGRES_MIGRATOR_PASSWORD": raw_key(),
        "NAGDI_NOTARY_POSTGRES_RUNTIME_PASSWORD": raw_key(),
        "CITIZEN_NOTARY_POSTGRES_MIGRATOR_PASSWORD": raw_key(),
        "CITIZEN_NOTARY_POSTGRES_RUNTIME_PASSWORD": raw_key(),
        "CITIZEN_ISSUER_NOTARY_POSTGRES_MIGRATOR_PASSWORD": raw_key(),
        "CITIZEN_ISSUER_NOTARY_POSTGRES_RUNTIME_PASSWORD": raw_key(),
        "CITIZEN_ISSUER_NOTARY_SENSITIVE_STATE_KEY": raw_key(),

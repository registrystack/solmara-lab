...
// wire contract: signed authority Evidence assertions or a portal composition.
//
...
// Authority-owned Evidence service shown in request provenance.
...
export type ScenarioResult = {
  ...
  // ---- Authority Evidence request shaping ----
...
export const SCENARIOS: Record<string, ScenarioResult> = {
  ...
  'caregiver-link': {
    ...
    answered: 'Civil Registration Authority answered: birth-is-registered = true',
  ...
  'population-record-active': {
    ...
    headline: 'Confirmed by National Identity Agency Evidence',
  ...
  'date-of-birth': {
    ...
    headline: 'Confirmed by Civil Registry, released only after the guardian link was proven',
    answered: 'Civil Registration Authority answered: child-age-under-5 = true',
  ...
  'household-composition': {
    ...
    headline: 'Confirmed by Social Registry Office Evidence',
  ...
  'person-is-alive': {
    ...
    answered: 'Civil Registration Authority answered: person-is-deceased = true',
    notDisclosed: 'Not disclosed: any other civil record detail',
    status: 'ok',
    httpStatus: 200,
    latencyMs: 800,
  ...
  ambiguous: {
    ...
    answered: 'Civil Registration Authority answered: 2 candidate records, no single match',

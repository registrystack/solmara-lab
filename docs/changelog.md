...
strip now probes the full topology (metadata, scenario runner, portal, six
relays, four notaries) with honest auth-gated semantics, reads the newest smoke
evidence, and shows the generated data seed from the generator output. The
